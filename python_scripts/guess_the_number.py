...
if guess == number:
    print(
        "Congratulations {}, you guessed the number in {} tries!".format(
            player_name, number_of_guesses
        )
    )
else:
    print(
        "Close but no cigar, you couldn't guess the number. \nWell, the number was {}.".format(
            number
        )
    )
